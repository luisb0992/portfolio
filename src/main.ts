...
import { faUserSecret, faEnvelope, faFileLines } from "@fortawesome/free-solid-svg-icons";
import { faLinkedinIn, faGithub, faWhatsapp } from "@fortawesome/free-brands-svg-icons";

/* add icons to the library */
library.add(faUserSecret, faLinkedinIn, faEnvelope, faGithub, faWhatsapp, faFileLines);
