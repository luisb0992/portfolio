...
<template>
  <header class="bg-personal-dark-blue-1 sticky top-0 z-[1]">
    ...
    >
      <nav
        class="flex lg:w-2/5 flex-wrap items-center text-sm sm:text-base md:ml-auto py-2 justify-center sm:justify-start gap-3 sm:gap-0"
      >
        <a
      ...
      <a
        class="hidden sm:flex order-first lg:order-none lg:w-1/5 font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0"
      >
        <Logo
      ...
      <div
        class="lg:w-2/5 inline-flex justify-center lg:justify-end items-center"
      >
        <a
          :href="RRSS.linkedin"
          target="_blank"
